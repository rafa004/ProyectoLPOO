...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			// button2
			// 
			this->button2->Location = System::Drawing::Point(171, 202);
			...
			this->groupBox1->Size = System::Drawing::Size(384, 151);
			...
			this->ClientSize = System::Drawing::Size(419, 243);
			this->Controls->Add(this->button2);
			this->Controls->Add(this->groupBox1);
			this->Margin = System::Windows::Forms::Padding(2, 2, 2, 2);
			this->Name = L"frmAgregarEstacionPesaje";
			this->Text = L"Añadir Estacion Pesaje";
